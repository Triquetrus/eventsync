...
// PlatformPreview starts at line 4 (index 3) and ends at line 155 (index 154) in backup_CaptionStudioTab.jsx
lines.splice(3, 152, newPreview);

fs.writeFileSync('src/components/CaptionStudioTab.jsx', lines.join('\n'));
console.log("Updated PlatformPreview safely");
